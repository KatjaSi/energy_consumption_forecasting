...
def _read_frost_data(data_path=data_path):
...
def _read_consumption_data(data_path=data_path):
    cons = pd.read_csv(
...
def read_consumption_and_weather(data_path=data_path):
    cons_raw = _read_consumption_data(data_path=data_path)
    cons = _preprocess_consumption_data(cons_raw)

    frost_raw = _read_frost_data(data_path=data_path)
